...
SECRET_KEY = 'django-insecure-a6s6)k-km!8!oc33m764n9q@c98j9#ji93t%wn9&!6dyaw@-s^'
...
SESSION_ENGINE = "django.contrib.sessions.backends.db"  # Use database storage
SESSION_COOKIE_AGE = 60 * 60 * 24 * 7  # Sessions last 7 days
...
STATICFILES_DIRS = [
    BASE_DIR / 'frontend/static',  # Path to your React app's static folder
]
